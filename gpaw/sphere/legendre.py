...
def legendre(l, m, w):
    ...
    if (l, m) == (0, 0):
        ...
        return (1 - w**2)**0.5 * (187.6875 * w**6 - 216.5625 * w**4 +
                                  59.0625 * w**2 - 2.1875)
    elif (l, m) == (7, 2):
        ...
        return (1 - w**2)**0.5 * (402.1875 * w**7 - 563.0625 * w**5 +
                                  216.5625 * w**3 - 19.6875 * w)
    elif (l, m) == (8, 2):
        return (1 - w**2) * (2815.3125 * w**6 - 2815.3125 * w**4 +
                             649.6875 * w**2 - 19.6875)
    elif (l, m) == (8, 3):
        return (1 - w**2)**1.5 * (16891.875 * w**5 - 11261.25 * w**3 +
                                  1299.375 * w)
    elif (l, m) == (8, 4):
        ...
        return (1 -
                w**2)**0.5 * (854.6484375 * w**8 - 1407.65625 * w**6 +
                              703.828125 * w**4 - 108.28125 * w**2 + 2.4609375)
    elif (l, m) == (9, 2):
        return (1 - w**2) * (6837.1875 * w**7 - 8445.9375 * w**5 +
                             2815.3125 * w**3 - 216.5625 * w)
    elif (l, m) == (9, 3):
        return (1 - w**2)**1.5 * (47860.3125 * w**6 - 42229.6875 * w**4 +
                                  8445.9375 * w**2 - 216.5625)
    elif (l, m) == (9, 4):
        return (1 - w**2)**2 * (287161.875 * w**5 - 168918.75 * w**3 +
                                16891.875 * w)
    elif (l, m) == (9, 5):
        return (1 - w**2)**2.5 * (1435809.375 * w**4 - 506756.25 * w**2 +
                                  16891.875)
    elif (l, m) == (9, 6):
...
def dlegendre(l, m, w):  # XXX not d/dw but rather -sin(theta)*d/dw
    ...
    if (l, m) == (0, 0):
        ...
        return (1 - w**2)**0.5 * (7882.875 * w**6 - 9961.875 * w**4 +
                                  2953.125 * w**2 - 118.125)
    elif (l, m) == (7, 3):
        ...
        return (1 - w**2)**0.5 * (22522.5 * w**7 - 33783.75 * w**5 +
                                  13860.0 * w**3 - 1338.75 * w)
    elif (l, m) == (8, 3):
        return (1 - w**2) * (135135.0 * w**6 - 152026.875 * w**4 +
                             38981.25 * w**2 - 1299.375)
    elif (l, m) == (8, 4):
        return (1 - w**2)**1.5 * (675675.0 * w**5 - 540540.0 * w**3 +
                                  72765.0 * w)
    elif (l, m) == (8, 5):
        ...
        return (1 - w**2)**0.5 * (61534.6875 * w**8 - 106981.875 * w**6 +
                                  56306.25 * w**4 - 9095.625 * w**2 + 216.5625)
    elif (l, m) == (9, 3):
        return (1 - w**2) * (430742.8125 * w**7 - 582769.6875 * w**5 +
                             211148.4375 * w**3 - 17541.5625 * w)
    elif (l, m) == (9, 4):
        return (1 - w**2)**1.5 * (2584456.875 * w**6 - 2618240.625 * w**4 +
                                  591215.625 * w**2 - 16891.875)
    elif (l, m) == (9, 5):
        return (1 - w**2)**2 * (12922284.375 * w**5 - 9290531.25 * w**3 +
                                1097971.875 * w)
    elif (l, m) == (9, 6):
        return (1 - w**2)**2.5 * (51689137.5 * w**4 - 24324300 * w**2 +
                                  1013512.5)
    elif (l, m) == (9, 7):
...
if __name__ == '__main__':
    ...
    for l, m in lmiter(lmax, False, comm=world):
        ...
        print('l=%2d, m=%2d, err=%12.9f, max=%12.9f' %
              (l, m, e, np.abs(dpdtheta - dpdtheta0).max()))
        #if e > tol:
        #    import pylab as pl
        #    w, p = w[1:-1], p[1:-1]
