...
class HydrogenAllElectronSetup(BaseSetup):
    ...
    def __init__(self, symbol, alpha1=10.0, alpha2=300.0):
        self.alpha1 = alpha1
        self.alpha2 = alpha2
        ...
        if symbol == 'H':
            ...
            raise ValueError(f'{symbol} not supported for all electron setup.')
        self.Nc = 0
        self.nao = None
        self.pt_j = []
        self.ni = 0
