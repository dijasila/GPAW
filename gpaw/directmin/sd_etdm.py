...
class SteepestDescent_MF(ModeFollowingBase, SteepestDescent):
    def __init__(self, wfs, partial_diagonalizer):
        super(SteepestDescent_MF, self).__init__(wfs, partial_diagonalizer)
    ...
    def update_data(self, wfs, x_k1, g_k1, precond=None):
        g_k1 = self.negate_parallel_grad(g_k1)
        return super(SteepestDescent_MF, self).update_data(wfs, x_k1, g_k1,
                                                           precond=precond)


class FRcg_MF(ModeFollowingBase, FRcg):
    def __init__(self, wfs, partial_diagonalizer):
        super(FRcg_MF, self).__init__(wfs, partial_diagonalizer)
    ...
    def update_data(self, wfs, x_k1, g_k1, precond=None):
        g_k1 = self.negate_parallel_grad(g_k1)
        return super(FRcg_MF, self).update_data(wfs, x_k1, g_k1,
                                                precond=precond)


class QuickMin_MF(ModeFollowingBase, QuickMin):
    def __init__(self, wfs, partial_diagonalizer):
        super(QuickMin_MF, self).__init__(wfs, partial_diagonalizer)
    ...
    def update_data(self, wfs, x_k1, g_k1, precond=None):
        g_k1 = self.negate_parallel_grad(g_k1)
        return super(QuickMin_MF, self).update_data(wfs, x_k1, g_k1,
                                                    precond=precond)


class LBFGS_MF(ModeFollowingBase, LBFGS):
    def __init__(self, wfs, partial_diagonalizer):
        super(LBFGS_MF, self).__init__(wfs, partial_diagonalizer)
    ...
    def update_data(self, wfs, x_k1, g_k1, precond=None):
        g_k1 = self.negate_parallel_grad(g_k1)
        return super(LBFGS_MF, self).update_data(wfs, x_k1, g_k1,
                                                 precond=precond)


class LBFGS_P_MF(ModeFollowingBase, LBFGS_P):
    def __init__(self, wfs, partial_diagonalizer):
        super(LBFGS_P_MF, self).__init__(wfs, partial_diagonalizer)
...
class LSR1P_MF(ModeFollowingBase, LSR1P):
    def __init__(self, wfs, partial_diagonalizer):
        super(LSR1P_MF, self).__init__(wfs, partial_diagonalizer)
    ...
    def update_data(self, wfs, x_k1, g_k1, precond=None):
        g_k1 = self.negate_parallel_grad(g_k1)
        return super(LSR1P_MF, self).update_data(wfs, x_k1, g_k1,
                                                 precond=precond)
