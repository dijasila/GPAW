...
class Parabola(UnitStepLength):
    ...
    def step_length_update(self, x, p,
                           *args, **kwargs):
        ...
        phi_i, der_phi_i, g_i = \
            self.evaluate_phi_and_der_phi(x, p, 1.0, *args)
...
class StrongWolfeConditions(UnitStepLength):
    ...
    def step_length_update(self, x, p, *args, **kwargs):
        ...
        if phi_0 is None or der_phi_0 is None:
            phi_0, der_phi_0, g_0 = \
                self.evaluate_phi_and_der_phi(x, p, 0.0, *args)
    ...
    def zoom(self, a_lo, a_hi, f_lo, df_lo, f_hi, df_hi, x,
             p, phi_0, der_phi_0, c1, c2, *args):
        ...
        while True:
            ...
            phi_j, der_phi_j, g_j = \
                self.evaluate_phi_and_der_phi(x, p, a_j, *args)
