...
class SpinChargeResponseFunction:
    ...
    def get_spin_response_function(self, xc='RPA', q_c=[0, 0, 0], q_v=None,
        ...
        Returns spin response function without and with local field correction:
        srf_RPA_w, srf_xc_w = SpinChargeResponseFunction.get_spin_response_function()
        
        REMARK: currently only RPA implemented, that is chi^{pm}=chi^{pm,0}
        """
