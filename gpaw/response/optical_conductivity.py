...
#def get_berrycurvature(calc, kpts_k=None, n1=0, n2=None, mi=None, mf=None, width=None, theta=0.0, phi=0.0, scale=1.0):
...
#def get_optical_conductivity(calc, kpts_k=None, n1=0, n2=None, mi=None, mf=None, width=None, theta=0.0, phi=0.0, scale=1.0):
#    berryc_xy_k, berryc_yz_k, berryc_zx_k = get_berrycurvature(calc, kpts_k=None, n1=0, n2=None, mi=None, mf=None, width=None, theta=0.0, phi=0.0, scale=1.0)
