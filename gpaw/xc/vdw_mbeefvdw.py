...
class METAVDWFunctional(MGGA):
    ...
    def calculate_gga(self, e_g, n_sg, dedn_sg, sigma_xg, dedsigma_xg):
        MGGA.calculate_gga(self, e_g, n_sg, dedn_sg, sigma_xg, dedsigma_xg)
...
class METAFFTVDWFunctional(METAVDWFunctional):
    ...
    def __init__(self, name='vdW-DF',
        ...
        METAVDWFunctional.__init__(self, name, **kwargs)
        self.Nalpha = Nalpha
        self.lambd = lambd
        self.rcut = rcut
        self.Nr = Nr
    ...
    def initialize(self, density, hamiltonian, wfs, occupations):
        MGGA.initialize(self, density, hamiltonian, wfs, occupations)
    ...
    def set_grid_descriptor(self, gd):
        ...
        METAVDWFunctional.set_grid_descriptor(self, gd)
