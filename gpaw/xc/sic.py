...
class SIC(XCFunctional):
    ...
    def read_unitary_transformation(self, reader):
        #
    ...
    def write_unitary_transformation(self, writer):
        #
...
class SICSpin:
    ...
    def initialize_orbitals(self, rattle=-0.1, localize=True):
        ...
        if rattle!=0.0 and self.W_mn!=None and self.initial_W_mn==None:
