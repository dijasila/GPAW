...
"""
    ...
    It appears, that the article has a typo, because the summation starts at p=1, but correct results require to start at p=0.
...
class ScreenedCoulombKernelDebug:
    def __init__(self, rgd, omega):
        ...
        for l in range(3):
            kernel_gg = Phiold(l, rmax_gg, rmin_gg, omega) / (2*l+1)
