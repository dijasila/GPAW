...
@pytest.mark.parametrize('gpw, kwargs, ref_energy, abstol', [
    ('h2_pw280_fulldiag_wfs', dict(xc='rALDA', nblocks=min(4, world.size)),
     -0.8509, 1e-3),
    ('h2_pw280_fulldiag_wfs', dict(xc='rAPBE'), -0.74555, 1e-3),
    ('h_pw280_fulldiag_wfs', dict(xc='rALDA'), 0.002757, 1e-4),
    ('h_pw280_fulldiag_wfs', dict(xc='rAPBE', nblocks=min(4, world.size)),
     0.01365, 1e-4),
])
