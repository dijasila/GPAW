...
if False:
    ...
    ## exponent = 3.4
    ## Felref = numpy.array([[ 1.29276937,  1.48687732, -4.93777752],
    ##           [-0.87351208, -0.67926378,  3.05644592],
    ##           [-0.54559522, -0.7702362,   1.8756392 ]])
    ## Felcavref = numpy.array([[ 1.32413255,  1.49849259, -5.05619571],
    ##              [-0.88826466, -0.78665117,  3.1117918 ],
    ##              [-0.56220416, -0.67447946,  1.93870498]])

    ## exponent = 5.2
    Felref = numpy.array([[ 1.35345169,  1.50031552, -5.11273361],
                          [-0.87188945, -0.81395632,  3.18881748],
                          [-0.44953014, -0.68586012,  1.99575804]])
    Felcavref = numpy.array([[ 1.3849986,   1.51150178, -5.23239923],
                             [-0.88665469, -0.92262691,  3.24421296],
                             [-0.46620038, -0.59006137,  2.05900746]])
