...
equal(val1, 3307.65264221, tol)
equal(val2, 2.24602807031, tol)
equal(val3, 2.20371259376, tol)
equal(val4, 1.69235739697, tol)
equal(val5, 3305.67551203, tol)
