...
relative_equal(val1, 3314.4687247954053, tol)
relative_equal(val2, 2.2544610801998815, tol)
relative_equal(val3, 2.2089702543970193, tol)
relative_equal(val4, 1.6975670957094118, tol)
relative_equal(val5, 3311.7608134815737, tol)
relative_equal(val6, 2.102508154206625, tol)
relative_equal(val7, 2.1038712082637567, tol)
relative_equal(val8, 1.602254592413304, tol)
