...
for mode in ['serial', 'mpi', 'pfft']:
    ...
    # old values using other stencil
    ...
    test(vdw_df, -3.8730338473027368, -4.9051822964227210)
    test(vdw_df2, -3.9017516508476211, -4.9338883507236160)
    test(vdw_df_cx_part, -3.7262055126634617, -4.7604274530481288)

    test(vdw_optPBE, -3.7954301470245491, -4.8344599805736754)
    test(vdw_optB88, -3.8486341085883597, -4.8790049317301181)
    test(vdw_C09, -3.7071082922039449, -4.7461138080444956)
