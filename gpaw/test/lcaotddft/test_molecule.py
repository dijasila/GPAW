...
def test_propagated_wave_function(initialize_system, module_tmp_path):
    ...
    ref = [[[[1.65647726e-02 + 1.21589404e-01j,
              4.74645685e-03 + 3.49178517e-02j,
              8.21520470e-07 - 1.63443335e-06j],
             [1.51770900e-01 + 7.65027159e-02j,
              8.04975534e-01 + 4.05738379e-01j,
              -5.15059526e-06 - 1.15079189e-05j],
             [2.51162339e+00 + 3.67763214e-01j,
              1.90250079e-01 + 2.78438831e-02j,
              -1.38487391e-05 - 2.64022129e-05j]]]]
