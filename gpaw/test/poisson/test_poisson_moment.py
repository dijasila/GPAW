...
def test_poisson_moment_correction(gd):
    ...
    # Remember that the solver expects Ångström units and we have specified the grid in Bohr
    moment_corrections = [{'moms': range(4), 'center': np.array([.5, .5, 1]) * Bohr},
    ...
    poisson_ref2 = ExtraVacuumPoissonSolver(gpts=(24, 24, 3 * 24), poissonsolver_large=poisson_ref)
