...
def test_Co_hcp(in_tmp_dir, gpw_files):
    ...
    # print(mw_qnp[..., 1])
    # print(mwuc_qs[:, 0])
    test_J_qab = np.array([[[1.19144616 - 0.j, 0.26601377 - 0.j],
                            [0.26601377 + 0.j, 1.19144616 + 0.j]],
                           [[0.84621145 + 0.j, 0.07148300 - 0.04710547j],
                            [0.07148300 + 0.04710547j, 0.84621145 + 0.j]],
                           [[1.05538213 - 0.j, 0.00000011 - 0.01115755j],
                            [0.00000011 + 0.01115755j, 1.05538213 - 0.j]]])
    test_mw_qn = np.array([[0., 0.66764242],
                           [0.65962716, 0.87448668],
                           [0.49056659, 0.51856986]])
    test_mwuc_q = np.array([0., 0.7078635, 0.45723129])
