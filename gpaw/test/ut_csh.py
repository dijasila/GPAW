...
from gpaw.sphere.rsh import C as _C, Y as _Y, \
...
def condYdYdtheta(l1, m1, l2, m2, lquad=11, out=False):
    ...
    out |= l1+l2 >= lquad and (l1-l2)%2 == 1 and abs(m1-m2)%4 == 0
    return out
...
class UTSphereParallelSetup(TestCase):
    """Test case for various properties of the complex spherical harmonics"""
...
if __name__ in ['__main__', '__builtin__']:
    ...
    if __name__ == '__builtin__':
        testrunner = CustomTextTestRunner('ut_csh.log', verbosity=2)
    else:
