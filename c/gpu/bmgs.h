...
// complex routines:
double bmgs_fd_cuda_cpuz(const bmgsstencil* s, const cuDoubleComplex* a,
                         cuDoubleComplex* b, int boundary, int blocks);

void bmgs_fd_cuda_gpuz(const bmgsstencil_gpu* s, const cuDoubleComplex* adev,
                       cuDoubleComplex* bdev, int boundary, int blocks,
                       cudaStream_t stream);
...
void reducemap_dotuz(const cuDoubleComplex* a_gpu,
                     const cuDoubleComplex* b_gpu, cuDoubleComplex* result,
                     int n, int nvec);
