...
bmgsstencil bmgs_laplace(int k, double scale, const double h[3], 
			 const long n[3]);
...
void bmgs_restrict(int k, double* a, const int n[3], double* restrict b, 
		   double* restrict w);
...
void bmgs_restrictz(int k, double_complex* a, const int n[3], 
		    double_complex* restrict b, double_complex* restrict w);
