      ...
      switch(l)\
        {\
          ...
          case 3:\
            ...
            p[4] = f * 2.7422747967867944 * -x;\
            p[5] = f * 2.8906114426405538 * z;\
            p[6] = f * 3.5402615395598613 * x;\
            break;\
          case 4:\
            p[0] = f * 15.020057650780227 * x*y;\
            p[1] = f * 10.620784618679583 * y*z;\
            p[2] = f * 5.6770481745453605 * -x*y;\
            p[3] = f * 4.0142792613437353 * -y*z;\
            p[4] = f * 1.2694265629824517 * (r2+2*x*x-5*z*z);\
            p[5] = f * 12.042837784031205 * -x*z;\
            p[6] = f * 0.94617469575756008 * (y*y-r2-5*x*x+7*z*z);\
            p[7] = f * 10.620784618679583 * x*z;\
            p[8] = f * 7.5100288253901137 * (-y*y+x*x);\
            break;\
          default:\
            assert(0 == 1);\
        }\
      ...
      switch(l)\
        {\
          ...
          case 3:\
            ...
            p[3] = f * 0;\
            p[4] = f * 0.91409159892893155 * -y;\
            p[5] = f * 0;\
            p[6] = f * 3.5402615395598613 * -y;\
            break;\
          case 4:\
            p[0] = f * 7.5100288253901137 * (-y*y+x*x);\
            p[1] = f * 10.620784618679583 * x*z;\
            p[2] = f * 0.94617469575756008 * (-2*y*y-r2+7*z*z-2*x*x);\
            p[3] = f * 4.0142792613437353 * -x*z;\
            p[4] = f * 2.5388531259649034 * x*y;\
            p[5] = f * 4.0142792613437353 * -y*z;\
            p[6] = f * 0;\
            p[7] = f * 10.620784618679583 * -y*z;\
            p[8] = f * 15.020057650780227 * -x*y;\
            break;\
          default:\
            assert(0 == 1);\
        }\
      ...
      switch(l)\
        {\
          ...
          case 4:\
            ...
            p[2] = f * 11.354096349090721 * y*z;\
            p[3] = f * 4.0142792613437353 * -x*y;\
            p[4] = f * 10.155412503859614 * -x*z;\
            p[5] = f * 2.0071396306718676 * (-r2+5*z*z-2*x*x);\
            p[6] = f * 11.354096349090721 * x*z;\
      ...
      switch(l)\
        {\
          ...
          case 2:\
            ...
            p[2] = f * 0.63078313050504009 * -1;\
            p[3] = f * 0;\
            p[4] = f * 1.0925484305920792 * -1;\
            break;\
          case 3:\
            p[0] = f * 3.5402615395598613 * -y;\
            p[1] = f * 0;\
            p[2] = f * 2.7422747967867944 * -y;\
            p[3] = f * 2.2390579955406924 * -z;\
          ...
          case 4:\
            ...
            p[1] = f * 10.620784618679583 * -y*z;\
            p[2] = f * 5.6770481745453605 * -x*y;\
            p[3] = f * 12.042837784031205 * -y*z;\
            p[4] = f * 1.2694265629824517 * (2*y*y+r2-5*z*z);\
            p[5] = f * 4.0142792613437353 * -x*z;\
            p[6] = f * 0.94617469575756008 * (5*y*y+r2-7*z*z-x*x);\
            p[7] = f * 10.620784618679583 * -x*z;\
            p[8] = f * 7.5100288253901137 * (y*y-x*x);\
            break;\
          default:\
      ...
      switch(l)\
        {\
          ...
          case 4:\
            ...
            p[2] = f * 11.354096349090721 * x*z;\
            p[3] = f * 2.0071396306718676 * (-2*y*y-r2+5*z*z);\
            p[4] = f * 10.155412503859614 * -y*z;\
            p[5] = f * 4.0142792613437353 * -x*y;\
            p[6] = f * 11.354096349090721 * -y*z;\
      ...
      switch(l)\
        {\
          ...
          case 4:\
            ...
            p[3] = f * 16.057117045374941 * y*z;\
            p[4] = f * 5.0777062519298068 * (-r2+3*z*z);\
            p[5] = f * 16.057117045374941 * x*z;\
