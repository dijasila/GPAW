...
uc = npy.array([(2 * a, 0, 0),
                (0,     a, 0),
                (0,     0, a)])
e1 = VanDerWaals(d, unitcell=uc,xcname='revPBE').get_energy(n=4)
d += d[::-1].copy()
e2 = VanDerWaals(d, unitcell=uc,xcname='revPBE').get_energy(n=4)
print  'revPBE',e1, e2, 2 * e1 - e2
#RPBE
e1 = VanDerWaals(d, unitcell=uc,xcname='RPBE').get_energy(n=4)
d += d[::-1].copy()
e2 = VanDerWaals(d, unitcell=uc,xcname='RPBE').get_energy(n=4)
