...
stock GPAW config.py file :svn:`config_mira.py`.
...
(:svn:`bgq_xlc.py` and :svn:`bgq_xlc_linker.py`). A build script for
GPAW is provided for convenience :svn:`build_gpaw.sh`.
...
directory if each Python library (Scalable Python, NumPy, ASE, and
