...
bands = slice(3, 5)  # Electronic bands (valence + conduction)
...
kpts_kc = kpoint_convert(cell_cv, ckpts_kv=kpts_kv)
...
K_kv = kpoint_convert(cell_cv, skpts_kc=K_kc)
k0_v = kpoint_convert(cell_cv, skpts_kc=k0_c)

# Convert to units of (2pi/a)
a = la.norm(cell_cv[0])
kx_vv /= (2*pi / a)
ky_vv /= (2*pi / a)
K_kv /= (2*pi / a)
