...
(:git:`~doc/tutorials/elphraman/phonon.py`)
...
(:git:`~doc/tutorials/elphraman/elph.py`)
...
parallelisation over domains disabled. (:git:`~doc/tutorials/elphraman/supercell_matrix.py`)
