...
def workflow():
    return [
        ...
        Job('silicon_ABS.py@16:1h'),
        Job('plot_ABS.py', deps=['silicon_ABS.py']),
        Job('aluminum_EELS.py@8:1h'),
        Job('plot_aluminum_EELS_simple.py', deps=['aluminum_EELS.py']),
        Job('graphite_EELS.py@8:1h'),
        Job('plot_EELS.py', deps=['graphite_EELS.py']),
        Job('tas2_dielectric_function.py@8:15m'),
        Job('graphene_dielectric_function.py@8:15m')]
