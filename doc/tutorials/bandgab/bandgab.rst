...
=========================
Calculating bandgab using the GLLB-sc functional
=========================

In this tutorial, we use the GLLB-sc to calculate the bandgab of KTaO3 using the 
...
This has been shown to improve the bandgab description as shown in the figure 
below taken from [Castilli2012].

.. figure:: sodium_bands.png

A GLLB-sc bandgab calculation is performed as given here: 

.. literalinclude:: gllbsc_bandgab.py
