...
for i, ecut in enumerate([100,200,300]):
    fil = pickle.load(paropen('output_files/C-g0w0_k8_ecut%s_results.pckl' %(ecut), 'rb'))
...
for j, omega2 in enumerate([1, 5, 10, 15, 20, 25]):
    fil = pickle.load(paropen('output_files/C_g0w0_domega0_0.02_omega2_%s_results.pckl' %(omega2),'rb'))
