...
fxc0 = FXCCorrelation('CO.gpw', xc='rAPBE', txt='rapbe_CO.txt')    
fxc1 = FXCCorrelation('C.gpw', xc='rAPBE', txt='rapbe_C.txt')    
fxc2 = FXCCorrelation('O.gpw', xc='rAPBE', txt='rapbe_O.txt')
...
rpa0 = RPACorrelation('CO.gpw', txt='rpa_CO.txt')    
rpa1 = RPACorrelation('C.gpw', txt='rpa_C.txt')    
rpa2 = RPACorrelation('O.gpw', txt='rpa_O.txt')
