...
:Tar-file:
    ...
    latest stable release (gpaw-24.5.0.tar.gz_) or the latest
    development snapshot (`<snapshot.tar.gz>`_).

    Unpack and make a soft link::

        $ tar -xf gpaw-24.5.0.tar.gz
        $ ln -s gpaw-24.5.0 gpaw
...
:Git clone:
    ...
    https://gitlab.com/gpaw/gpaw like this::
        ...
        $ git clone -b 24.5.0 https://gitlab.com/gpaw/gpaw.git
...
.. _gpaw-24.5.0.tar.gz:
    https://pypi.org/packages/source/g/gpaw/gpaw-24.5.0.tar.gz
