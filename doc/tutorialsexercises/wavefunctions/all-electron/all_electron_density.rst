...
:meth:`~gpaw.GPAW.get_pseudo_density` method of the GPAW
...
the method :meth:`~gpaw.GPAW.get_all_electron_density` of the
:class:`~gpaw.GPAW` class:
...
The :meth:`~gpaw.GPAW.get_all_electron_density` method is used in
