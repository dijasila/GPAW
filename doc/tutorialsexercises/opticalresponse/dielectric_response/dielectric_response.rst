...
.. autoclass:: gpaw.response.frequencies.NonLinearFrequencyDescriptor
   :members:
.. autoclass:: gpaw.response.frequencies.GridFrequencyDescriptor
   :members:
...
:git:`~doc/tutorialsexercises/opticalresponse/dielectric_response/graphite_EELS.py`. The results
